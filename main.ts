...
function averageWeeklyTemperature(
  ...
  const validReadings = readings.filter(
    (reading) => reading.city === city && reading.date.getTime() > oneWeekAgo
  );
